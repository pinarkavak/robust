...
--dbsnp $DBSNP \
-o pooled_$INPUT\_$INPUT2.b37.vcf \
...
$cmd="java -d64 -Xmx8g -jar $GATK \
-input pooled_$INPUT\_$INPUT2.b37.vcf \
-R $REF \
...
-recalFile pooled_$INPUT\_$INPUT2.b37.recal \
-tranchesFile pooled_$INPUT\_$INPUT2.b37.tranches \
-rscriptFile pooled_$INPUT\_$INPUT2.b37.R \
...
-tranchesFile pooled_$INPUT\_$INPUT2.b37.tranches \
-mode BOTH \
-o pooled_$INPUT\_$INPUT2.b37_vqsrfilter.vcf";
print STDERR "$cmd\n";
system($cmd);

#GATK Additional hard filtering
$cmd="java -d64 -Xmx8g -jar $GATK \
--variant pooled_$INPUT\_$INPUT2.b37_vqsrfilter.vcf \
-T VariantFiltration \
-R $REF \
-o pooled_$INPUT\_$INPUT2.b37_vqsrfilter_refilter.vcf \
