...
-mode BOTH \
-recalFile $INPUT\_HC\_b37.recal \
-tranchesFile $INPUT\_HC\_b37.tranches \
-rscriptFile $INPUT\_HC\_b37.R \
-nt 6 \
...
-input $INPUT\_HC\_b37.vcf \
-R $REF \
--ts_filter_level 99.0 \
-recalFile $INPUT\_HC\_b37.recal 
-tranchesFile $INPUT\_HC\_b37.tranches \
-o $INPUT\_HC\_b37_vqsrfilter.vcf";
print STDERR "$cmd\n";
system($cmd);
...
-T VariantFiltration \
-R $REF \
-o $INPUT\_HC\_b37_vqsrfilter_refilter.vcf \
--variant $INPUT\_HC.b37_vqsrfilter.vcf \
